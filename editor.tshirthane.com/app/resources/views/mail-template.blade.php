...
if(!isset($to)) $to = env('MAIL_USERNAME');
?>
                                ...
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    <h1 style="color:#005c6a;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">
                                      <img src="{{env("APP_URL")}}/assets/logo.svg" width="128" style="margin:20px auto;display:block" alt="{{env("APP_NAME")}}">
                                  </h1>
                                ...
                                <tbody><tr>
                                  <td valign="top" bgcolor="#E1E1E1">
                                    ...
                                    <div>Copyright © {{date("Y")}}. {{env("APP_NAME")}}.</div>
                                      <div>Eğer bu tarz e-postaları almak istemiyorsanız. <a href="https://app.{{env("APP_NAME")}}.com/unsubscribe?mail={{$to}}" target="_blank" style="text-decoration:underline;color:#828282;"><span style="color:#828282;">abonelikten çıkabilirsiniz</span></a>.</div>
                                    </div>
